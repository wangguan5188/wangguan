...
public class AddressUtil {
	...
	public static String getAddresses(String content, String encodingString) throws UnsupportedEncodingException {
		...
		if (returnStr != null) {
			...
			String fin = country+"-"+area+"-"+region+"-"+city+"-"+county+"-"+isp;
			//return region;
			return fin;
		}
		return null;
			...
			if (aChar == '\\') {
				...
				if (aChar == 'u') {
					...
					for (int i = 0; i < 4; i++) {
						...
						case 'd':
						case 'e':
						case 'f': value = (value << 4) + 10 + aChar - 'a';
							break;
						case 'A':
						case 'B':
						case 'C':
	...
	public static void main(String[] args) {
		...
		String ip = "219.136.134.157"; // 中国-华南-广东省-广州市-越秀区-电信
		//String ip = "122.49.20.255";// 中国-华北-北京市-北京市--
		//String ip = "119.164.10.200";// 中国-华东-山东省-济南市--联通
		String address = "";
		try {
